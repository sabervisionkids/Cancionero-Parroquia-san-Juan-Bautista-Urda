...
(() => {
  ...
  // src/cdn.ts
  // Copias LOCALES (offline): descargadas en vendor/, idénticas a las del CDN. Sin SRI
  // para no arriesgar un bloqueo de carga sin conexión (son ficheros de mismo origen).
